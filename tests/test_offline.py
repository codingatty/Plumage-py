...
class TestUM(unittest.TestCase):
    ...
    def test_F002_process_ST961D3(self):
        ...
        '''
        t = plumage.TSDRReq()
        with open("testfiles/ST96-V1.0.1.xsl") as f:
            ST961D3xslt = f.read()
    ...
    def test_F003_compare_ST96_support(self):
        ...
        t_old.getTSDRInfo("testfiles/rn2178784-ST-961_D3.xml")
        ...
        t_new.getTSDRInfo("testfiles/rn2178784-ST-962.2.1.xml")
    ...
    def test_F004_process_with_alternate_XSL(self):
        ...
        '''
        with open("testfiles/appno+pubdate.xsl") as f:
            altXSL = f.read()
        t = plumage.TSDRReq()
        t.setXSLT(altXSL)
        t.getTSDRInfo("testfiles/sn76044902.zip")
...
PublicationDate,"<xsl:value-of select="tm:PublicationDetails/tm:Publication/tm:PublicationDate"/>"<xsl:text/>
    ...
    def test_G001_XSLT_with_blanks(self):
        ...
        with open("testfiles/xsl_exception_test_skeleton.txt") as f:
            XSL_skeleton = f.read()
        XSLGUTS = "XSLGUTS\n" 
